...
public class DbService {
	...
	public void instantiateDatabase() throws ParseException {
		...
		Produto p4 = new Produto(null, "Mesa de Escritoriorio", 300.00);
		...
		Cliente cli1 = new Cliente(null, "Maria da Silva", "abmael_ninha@hotmail.com", "123456789",
				TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("65-9955888", "65-965654520"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "abmael.ninha@gmail.com", "72070068021", TipoCliente.PESSOAFISICA,
				pe.encode("123"));
		...
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2, sdf.parse("20/10/2017 10:20"),
				null);
